...
% Show example
The $\mathcal{I}_{\text{prop}}$ scaling procedure is illustrated in Figure~\ref{fig:propagator_scaling} using the ATLAS $\met+\gamma$ analysis in 36 \ifb of data~\cite{monophoton}. Circles show the locations of the signal points used; white points are excluded while red points are not excluded. 
%-----------------------------------
\begin{figure}[htp!]
  \begin{center}
  \begin{subfigure}[b]{0.49\textwidth}  
    \includegraphics[width=\textwidth]{figures/monox/EXOT-2016-27_AV_gq0p25_gchi1p0_gl0p0_compare.pdf}
    \caption{}
    \label{subfig:monophoton_A1}
  \end{subfigure}
  \begin{subfigure}[b]{0.49\textwidth}  
    \includegraphics[width=\textwidth]{figures/monox/EXOT-2016-27_AV_gq0p1_gchi1p0_gl0p1_compare.pdf}
    \caption{}
...
However, a ratio based on $\mathcal{I}_{\text{prop}}$ when the target scenario includes a different mediator model than the source scenario\ldots [Elaborate]
