...
\begin{document}
\title{\begin{boldmath} \huge LHC Dark Matter Working Group:  \\ Displaying dark matter constraints from colliders as a function of simplified model parameters \vspace{7mm} \end{boldmath}}
